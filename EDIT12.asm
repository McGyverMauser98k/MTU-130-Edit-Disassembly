...
2005   E5 F3                SBC $F3
2007   85 F9                STA $F9
2009   20 A6 CE             JSR $CE7C         ;$CEA6					;IODRIVER ROUTINE TO SCROLL UP SCREEN $CE7C ON KIM-1
200C   A5 0E                LDA $0E
200E   38                   SEC
200F   E5 B4                SBC $B4
2011   85 0E                STA $0E
...
221F   65 F9                ADC $F9
2221   85 0F                STA $0F
2223   20 A6 CE             JSR $CE7C         ;$CEA6					;IODRIVER ROUTINE TO SCROLL UP SCREEN $CE7C ON KIM-1
...
22AD   E5 F3                SBC $F3
22AF   85 F9                STA $F9
22B1   20 A6 CE             JSR $CE7C         ;$CEA6					;IODRIVER ROUTINE TO SCROLL UP SCREEN $CE7C ON KIM-1
22B4   A5 0E                LDA $0E
22B6   38                   SEC
22B7   E5 B4                SBC $B4
22B9   85 0E                STA $0E
...
24E1   20 3B D1             JSR $D111			;$D13B					;IODRIVER UPDATE VISABLE MEMORY POINTERS FOR DRAWING ON SCREEN KIM-1 - $D111
24E4   20 FD CF             JSR $CFD3			;$CFFD					;IODRIVER PREPARE DATA FROM FONT TABLE TO DISPLAY ON SCREEN KIM-1 - $CFD3
...
2533   20 49 D0   L2533:    JSR $D01F					;$D049			;IODRIVER DRAW CHARACTER ON SCREEN KIM-1 - $D01F
...
253E   20 DA CE   L253E:    JSR $CEB0					;$CEDA			;IODRIVER COLUMN POSITION UPDATE KIM-1 - $CEB0
...
267C   20 9D CE             JSR $CE73									;$CE9D					;IODRIVER UPDATE VISABLE MEMORY POINTERS FOR DRAWING ON SCREEN KIM-1 - $CE73
...
27F3   48         L27F3:    PHA
27F4   20 06 D1             JSR $D0DC						;$D106		;IODRIVER UPDATE VISABLE MEMORY POINTERS FOR DRAWING ON SCREEN KIM-1 - $D0DC
27F7   20 FF 27             JSR L27FF
27FA   20 27 D1             JSR $D0FD						;$D127		;IODRIVER UPDATE VISABLE MEMORY POINTERS FOR DRAWING ON SCREEN KIM-1 - $D0FD
27FD   68                   PLA
...
2871   06 F8                ASL $F8
2873   26 F9                ROL $F9
2875   20 06 D1   L2875:    JSR $D0DC						;$D106		;MEMORY BANK SWITCHING FOR VISABLE MEMORY IN MTU-130 TURN ON BANK 1- KIM-1 - $D0DC
2878   20 7E 28             JSR L287E
287B   4C 27 D1             JMP $D0FD						;$D127		;MEMORY BANK SWITCHING FOR VISABLE MEMORY IN MTU-130 TURN OFF BANK 1 RTS INCLUDED - KIM-1 - $D0FD
